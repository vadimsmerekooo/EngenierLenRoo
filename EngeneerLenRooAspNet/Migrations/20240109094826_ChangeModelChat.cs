        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateGet = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmployeeCreateId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    EmployeeAdministratorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chats_Employees_EmployeeAdministratorId",
                        column: x => x.EmployeeAdministratorId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Chats_Employees_EmployeeCreateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapNubmer = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatUsers", x => new { x.ChatUsersId, x.ChatsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatUsers_Employees_ChatUsersId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Chats",
                column: "EmployeeAdministratorId");

            migrationBuilder.CreateIndex(
                name: "IX_Chats_EmployeeCreateId",
                table: "Chats",
                column: "EmployeeCreateId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatUsers_ChatsId",
                table: "ChatUsers",
                column: "ChatsId");
